    ...
    public static partial class StaticData
    {
        ...
        static StaticData()
        {
            try
            {
                ...
                Data_MachineGroup.Add(new Common.Data_MachineGroup() { MachineGroupID = 6, MachineGroupName = "Máy đột" });
                Data_MachineGroup.Add(new Common.Data_MachineGroup() { MachineGroupID = 7, MachineGroupName = "Máy khoan" });
                Data_MachineGroup.Add(new Common.Data_MachineGroup() { MachineGroupID = 8, MachineGroupName = "Máy cắt" });
                ...
                Data_Machine.Add(new Common.Data_Machine() { Note = "High speed CNC Punching, Marking & Shearing machine for angles", ProviderName = "SCM", MachineID = 60, MachineName = "Máy đột V1010", MachineGroupID = 6, MachineGroupName = "Máy đột", Model = "TAPM1010-3", ImageUrl = "" });
                Data_Machine.Add(new Common.Data_Machine() { Note = "CNC Punching, Marking & Shearing machine for angles", ProviderName = "SCM", MachineID = 61, MachineName = "Máy đột V1010", MachineGroupID = 6, MachineGroupName = "Máy đột", Model = "TAPM1010-3", ImageUrl = "" });
                Data_Machine.Add(new Common.Data_Machine() { Note = "CNC Punching, Marking & Shearing machine for angles", ProviderName = "SCM", MachineID = 62, MachineName = "Máy đột V2020", MachineGroupID = 6, MachineGroupName = "Máy đột", Model = "TAPM2020A", ImageUrl = "" });
                Data_Machine.Add(new Common.Data_Machine() { Note = "CNC Punching, Marking & Shearing machine for angles", ProviderName = "SCM", MachineID = 63, MachineName = "Máy đột V2020", MachineGroupID = 6, MachineGroupName = "Máy đột", Model = "TAPM2020A", ImageUrl = "" });
                Data_Machine.Add(new Common.Data_Machine() { Note = "CNC Drilling & Marking line for angles", ProviderName = "SCM", MachineID = 64, MachineName = "Máy khoan V3536", MachineGroupID = 7, MachineGroupName = "Máy khoan", Model = "TBL3635", ImageUrl = "" });
                Data_Machine.Add(new Common.Data_Machine() { Note = "Máy dập lỗ thủy lực", ProviderName = "SCM", MachineID = 65, MachineName = "Máy khoan và đột mã CNC TPPR103", MachineGroupID = 7, MachineGroupName = "Máy khoan", Model = "TPPR103", ImageUrl = "" });
                Data_Machine.Add(new Common.Data_Machine() { Note = "CNC Drilling Machine for Steel Plate", ProviderName = "SCM", MachineID = 66, MachineName = "Máy khoan CNC cho tấm thép TPD 3016", MachineGroupID = 7, MachineGroupName = "Máy khoan", Model = "TPD3016", ImageUrl = "" });
                Data_Machine.Add(new Common.Data_Machine() { Note = "", ProviderName = "YAWEI", MachineID = 67, MachineName = "Máy cắt laser fiber Yawei HLF 2060", MachineGroupID = 8, MachineGroupName = "Máy cắt", Model = "HLF2060", ImageUrl = "" });
                Data_Machine.Add(new Common.Data_Machine() { Note = "", ProviderName = "BRUCO", MachineID = 68, MachineName = "Máy cắt CNC hạng nhẹ Bruco", MachineGroupID = 8, MachineGroupName = "Máy cắt", Model = "BLC3000", ImageUrl = "" });
                Data_Machine.Add(new Common.Data_Machine() { Note = "", ProviderName = "ACME", MachineID = 69, MachineName = "Máy cắt ống Laser ACME 6035", MachineGroupID = 8, MachineGroupName = "Máy cắt", Model = "ACME6035", ImageUrl = "" });
                ...
                Data_MachineLocationSetup.Add(new Common.Data_MachineLocationSetup() { MachineID = 60, MachineName = "Máy đột V1010", LocationID = 1, LocationName = "AH1" });
                Data_MachineLocationSetup.Add(new Common.Data_MachineLocationSetup() { MachineID = 61, MachineName = "Máy đột V1010", LocationID = 1, LocationName = "AH1" });
                Data_MachineLocationSetup.Add(new Common.Data_MachineLocationSetup() { MachineID = 62, MachineName = "Máy đột V2020", LocationID = 1, LocationName = "AH1" });
                Data_MachineLocationSetup.Add(new Common.Data_MachineLocationSetup() { MachineID = 63, MachineName = "Máy đột V2020", LocationID = 1, LocationName = "AH1" });
                Data_MachineLocationSetup.Add(new Common.Data_MachineLocationSetup() { MachineID = 64, MachineName = "Máy khoan V3536", LocationID = 1, LocationName = "AH1" });
                Data_MachineLocationSetup.Add(new Common.Data_MachineLocationSetup() { MachineID = 65, MachineName = "Máy khoan và đột mã CNC TPPR103", LocationID = 1, LocationName = "AH1" });
                Data_MachineLocationSetup.Add(new Common.Data_MachineLocationSetup() { MachineID = 66, MachineName = "Máy khoan CNC cho tấm thép TPD 3016", LocationID = 1, LocationName = "AH1" });
                Data_MachineLocationSetup.Add(new Common.Data_MachineLocationSetup() { MachineID = 67, MachineName = "Máy cắt laser fiber Yawei HLF 2060", LocationID = 1, LocationName = "AH1" });
                Data_MachineLocationSetup.Add(new Common.Data_MachineLocationSetup() { MachineID = 68, MachineName = "Máy cắt CNC hạng nhẹ Bruco", LocationID = 1, LocationName = "AH1" });
                Data_MachineLocationSetup.Add(new Common.Data_MachineLocationSetup() { MachineID = 69, MachineName = "Máy cắt ống Laser ACME 6035", LocationID = 1, LocationName = "AH1" });
